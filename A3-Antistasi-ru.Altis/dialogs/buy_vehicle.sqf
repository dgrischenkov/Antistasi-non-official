...
if (str (_display) != "no display") then
{
	...
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 3] call vehiclePrice];
	_ChildControl = _display displayCtrl 105;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 4] call vehiclePrice];
	_ChildControl = _display displayCtrl 106;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 5] call vehiclePrice];
	_ChildControl = _display displayCtrl 107;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 6] call vehiclePrice];
	_ChildControl = _display displayCtrl 108;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 7] call vehiclePrice];
	_ChildControl = _display displayCtrl 109;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 8] call vehiclePrice];
	_ChildControl = _display displayCtrl 110;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",[vfs select 9] call vehiclePrice];
