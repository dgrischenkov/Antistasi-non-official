...
if (str (_display) != "no display") then
{
	...
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",server getVariable "B_G_engineer_F"];
	_ChildControl = _display displayCtrl 108;
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",server getVariable "B_G_Soldier_exp_F"];
	...
	_ChildControl  ctrlSetTooltip format [localize "STR_COST",server getVariable "B_Soldier_AA_F"];
};